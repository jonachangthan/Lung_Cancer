...
file_path = "C:/Users/NUK_lab/Desktop/web_model/sel_fea.json"

# Load the list from the JSON file
with open(file_path, 'r') as file:
    selected_feature_name = json.load(file)

dicomPath = "C:/VS_Code/web2/invasiondcm/"
maskPath = "C:/VS_Code/web2/public/onlineInvasion/mask/"
...
for file in os.listdir(dicomPath):
    ...
    nrrd.write("C:/Users/NUK_lab/Desktop/web_model/dicom.nrrd", volume)
...
for file in os.listdir(maskPath):
    ...
    nrrd.write("C:/Users/NUK_lab/Desktop/web_model/mask.nrrd", mask_volume)
...
result = extractor.execute("C:/Users/NUK_lab/Desktop/web_model/dicom.nrrd", "C:/Users/NUK_lab/Desktop/web_model/mask.nrrd")
...
loaded_classifiers = []
for i in range(1, 6):  
    clf = joblib.load(f'C:/Users/NUK_lab/Desktop/web_model/su_model_{i}.joblib')
...
print("prediction:", int(majority_number))