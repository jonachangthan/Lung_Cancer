...
base_path = "C:/VS_Code/web2/public/uploadPNG/3/"
save_base_path = "C:/VS_Code/web2/public/uploadPNG/3/"
...
if os.path.isfile("public/uploadPNG/3/"+str(patient_index)+"/"+str(image_index)+"_original.png"):
    image_path = base_path + str(patient_index) + '/' + str(image_index) + '.png'
else:
    os.rename("public/uploadPNG/3/"+str(patient_index)+"/"+str(image_index)+".png","public/uploadPNG/3/"+str(patient_index)+"/"+str(image_index)+"_original.png")
