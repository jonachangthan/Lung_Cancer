...
for (var i =200; i >195; i--) {
    ...
    <div class="btnnn"><button class="btn btn-link" id="btn${i}"
            style="color:black;font-weight:bold;">結果${i}</button></div>
</li>`
}
...
for (var i = 150; i >135; i--) {
    ...
    <div class="btnnn"><button class="btn btn-link" id="btn${pid}"
            style="color:black;font-weight:bold;">結果${patientID}</button></div>
</li>`
}
...
async function populate() {
    ...
    const requestURL = 'http://140.127.208.159:8080/patient.json';
