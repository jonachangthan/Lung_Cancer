...
image_path = "C:/Users/NUK_lab/Desktop/Lung_Segmentation/result/original16/"
mask_path = "C:/Users/NUK_lab/Desktop/Lung_Segmentation/result/segmentation2/"
nodule_path = "C:/Users/NUK_lab/Desktop/Lung_Nodule_Segmentation/result2/"
model_path = "C:/Users/NUK_lab/Desktop/Lung_Nodule_Segmentation/model/"
# nodule_information = [3, 1, 112, 230] # image_no, nodule_no, coordinate_x, coordinate_y
nodule_information = [int(sys.argv[1]), 1, int(sys.argv[2]), int(sys.argv[3])]
if os.path.exists("C:/Users/NUK_lab/Desktop/Lung_Nodule_Segmentation/result2"):
    # If it exists, delete it
    shutil.rmtree("C:/Users/NUK_lab/Desktop/Lung_Nodule_Segmentation/result2")
os.mkdir("C:/Users/NUK_lab/Desktop/Lung_Nodule_Segmentation/result2")

main(dicom_path, image_path, mask_path, nodule_path, nodule_information, model_path)

# for web
# overlapped
os.makedirs("C:/VS_Code/web2/public/onlineSegementation_mul/nodule_overlapped", exist_ok=True)
for index, file in enumerate(os.listdir("C:/Users/NUK_lab/Desktop/Lung_Nodule_Segmentation/result2/1"), start=1):
    bottom = cv2.imread("C:/VS_Code/web2/public/onlineSegementation_mul/image/" + file, 1)
        
    mask = cv2.imread("C:/Users/NUK_lab/Desktop/Lung_Nodule_Segmentation/result2/1/" + file, 2)
    mask = cv2.cvtColor(mask, cv2.COLOR_GRAY2RGB) # 轉成3通道
    ...
    mask = cv2.bitwise_and(mask, paper)
    overlapping_image = cv2.addWeighted(bottom, 0.6, mask, 0.4, 0)
    
    cv2.imwrite("C:/VS_Code/web2/public/onlineSegementation_mul/nodule_overlapped/" + file, overlapping_image)

#zip mask
shutil.make_archive("C:/VS_Code/web2/public/onlineSegementation_mul/nodule_mask", 'zip', "C:/Users/NUK_lab/Desktop/Lung_Nodule_Segmentation/result2/1")