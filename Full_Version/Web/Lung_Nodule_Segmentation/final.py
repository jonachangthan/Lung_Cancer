...
def main(dicom_path, image_path, mask_path, nodule_path, nodule_information, model_path):
    ...
    cv2.imwrite(nodule_path + "result.png", nodule_mask)
    cv2.imwrite("C:/VS_Code/web2/public/onlineSegementation/noduleMask.png", nodule_mask)

    if(np.sum(nodule_mask) == 0):
        print('true')
        ROOT_DIR = os.path.abspath(".")
        MODEL_DIR = r'C:\Users\NUK_lab\Desktop\Lung_Nodule_Segmentation\model'
        #? print(MODEL_DIR)
        ...
        cv2.imwrite("C:/VS_Code/web2/public/onlineSegementation/noduleMask.png", final_mask)
    
    # overlapped
    bottom = cv2.imread("C:/VS_Code/web2/public/onlineSegementation/0001.png", 1)
        
    mask = cv2.imread(nodule_path + 'result.png', 2)
    ...
    cv2.imwrite("C:/VS_Code/web2/public/onlineSegementation/nodule.png", overlapping_image)

#TODO --------------------------------------------------------------------------------------------------------------------------------------

dicom_path = "C:/VS_Code/web2/segementationdcm/upload.dcm" # 001/001/0062 007/001/0066 003/001/0032
image_path = "C:/Users/NUK_lab/Desktop/Lung_Segmentation/result/original16/0001.tif"
mask_path = "C:/Users/NUK_lab/Desktop/Lung_Segmentation/result/segmentation2/0001.tif"
nodule_path = "C:/Users/NUK_lab/Desktop/Lung_Nodule_Segmentation/nodule/"
model_path = "C:/Users/NUK_lab/Desktop/Lung_Nodule_Segmentation/model/model1.pkl"
nodule_information = [int(sys.argv[1]), int(sys.argv[2])]
# nodule_information = [112, 231]
